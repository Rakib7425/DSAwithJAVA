 ...
 * medium
 * Problem Statement
 * Given a linked list consisting of N nodes, your task is to delete every kth
 * Node from the circular linked list until only one node is left. Also, print
 ...
 * just have to complete the function deleteK() that takes head node of circular
 * linked list and the integer K as parameter.
 * 
 * Constraints:
 * 1 <= K <= N <= 500
 * 1 <= Node. data<= 1000
