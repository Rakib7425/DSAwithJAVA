 ...
 * just have to complete the function PrintPattern() that takes the integer N
 ...
 * 
 * Explanation:
 * We basically first reduce 5 one by one until we reach a negative or 0. After
 * we reach 0 or negative, we one by one add 5 until we reach N.
 * 
 */