 ...
 * The puzzle starts with all the disks in ascending order of size on the first
 * row. The objective of the puzzle is to move the entire stack to another rod,
 ...
 * 1 ≤ N ≤ 16
 * Output
 * Print sequence of moving disks, where each move is shown in the following
 * format-
