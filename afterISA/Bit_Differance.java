 ...
 * Problem Statement
 * Given an array of N integers, your task is to calculate the sum of bit
 * difference in all pairs which can be formed.
 * Input
 * The first line of input contains a single integer N, the second line of input
 * contains N space separated integers depicting values of the array.
 * 
 * Constraints:-
 * 1 <= N <= 100000
 * 0 <= Arr[i] <= 1000000000
