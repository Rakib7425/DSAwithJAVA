 ...
 * 
 ...
 ? 
 ? You have an empty string s, you can do the following operation any number of
 ? times.
 ? 
 ? Choose any position of s and insert any AB string in that position.
 ? 
 ? You are given a string t of some length containing only A and B. Find out if
