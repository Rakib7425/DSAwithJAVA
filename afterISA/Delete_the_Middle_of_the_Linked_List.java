 ...
 * Problem Statement
 * Given a singly linked list, delete middle node of the linked list. For
 ...
 * 
 * In case of a single node return the head of a linked list containing only 1
 * node which has value -1
 * Input
 * User Task:
 * Since this will be a functional problem, you don't have to take input. You
 * just have to complete the function deleteMiddleElement() that takes head node
 * of the linked list as parameter.
 * 
 * Constraints:
 * 1 <=N<= 1000
 * 1 <=value<= 1000
 ...
 * 
 * 
 * Explanation: After deleting middle of the linked list, 3 will be deleted and
 * the list will be as 1, 2, 4, 5.
 * 
 * Sample Input 2:
 * 6
 * 1 2 3 4 5 6
